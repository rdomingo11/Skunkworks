...
namespace LottoML_net6
{
    ...
    {
        /// <summary>
        /// model input class for _655_slot5.
        /// </summary>
        #region model input class
        public class ModelInput
        {
            [ColumnName(@"sorted5")]
            public float Sorted5 { get; set; }
        ...
        /// <summary>
        /// model output class for _655_slot5.
        /// </summary>
        ...
        public class ModelOutput
        {
            ...
            [ColumnName(@"sorted5_LB")]
            public float[] Sorted5_LB { get; set; }

            [ColumnName(@"sorted5_UB")]
            public float[] Sorted5_UB { get; set; }

        }

        #endregion

        private static string MLNetModelPath = Path.GetFullPath(@"G:\projects\loabletech\LottoML.net\LottoML.net6\655-slot5.zip");
